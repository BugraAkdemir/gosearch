...
import "github.com/BugraAkdemir/gosearch/internal/serrors"
...
// fallback chain uses.
//
// These are re-exported from an internal package so that internal packages can
// return the same values without an import cycle; the identity is unchanged, so
// errors.Is works across the whole library.
var (
